      ...
      <header>
        <div className="header-container">
          ...
          <nav className="desktop-nav">
            <ul>
              <li><Link to="/business-solutions" className="active"><i className="fas fa-briefcase"></i>Business Solutions</Link></li>
        ...
        >
          <ul>
            <li className="nav-fade-in"><Link to="/business-solutions" className="active" onClick={handleMenuClick}><i className="fas fa-briefcase"></i>Business Solutions</Link></li>
