...
const Messages = () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_BASE_URL}/messages/send`,
        {
          ...
          jobId: activeConversation.jobId._id,
  ...
  const filteredConversations = conversations
    .filter((conversation) => {
      // Filter by search term (freelancer name or job title)
      const matchesSearch = 
        (conversation.otherUser?.name || "").toLowerCase().includes(searchTerm.toLowerCase()) ||
        (conversation.jobId?.title || "").toLowerCase().includes(searchTerm.toLowerCase());
  ...
  return (
    <div className="messages-container">
      <div className="messages-header">
        <h1>Messages</h1>
        <p>Communicate with freelancers about your jobs</p>
      </div>
          ...
          {loading ? (
            ...
            <div className="no-conversations">
              ...
              <p className="hint-text">
                Accept job applications to start messaging with freelancers.
              </p>
            </div>
          ) : (
                ...
                >
                  ...
                  <div className="conversation-info">
                    ...
                    <p className="conversation-job">
                      {conversation.jobId ? conversation.jobId.title : "Job Discussion"}
                    </p>
                    {conversation.lastMessage && (
              ...
              <div className="message-header">
                ...
                <div className="conversation-actions">
                  <button 
                    ...
                    onClick={() => navigate(`/view-profile/${activeConversation.otherUser._id}`)}
                  >
                    View Profile
                  </button>
                </div>
                      ...
                      >
                        <div className="message-content">
                          ...
                          <span className="message-time">
                            ...
                            {message.sender._id !== activeConversation.otherUser._id && message.isRead && (
